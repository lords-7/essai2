...
class RuboCop::Cop::RSpec::SharedExamples < ::RuboCop::Cop::RSpec::Base
  ...
  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#76
...
class RuboCop::Cop::RSpec::SharedExamples::StringChecker
  ...
  #
  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#111
  def initialize(node); end

  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#115
  def message; end

  # Returns the value of attribute node.
  #
  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#109
  def node; end

  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#119
  def preferred_style; end
end

# source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#106
...
class RuboCop::Cop::RSpec::SharedExamples::SymbolChecker
  ...
  #
  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#91
  def initialize(node); end

  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#95
  def message; end

  # Returns the value of attribute node.
  #
  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#89
  def node; end

  # source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#99
  def preferred_style; end
end

# source://rubocop-rspec//lib/rubocop/cop/rspec/shared_examples.rb#86
